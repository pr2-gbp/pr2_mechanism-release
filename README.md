## pr2_mechanism (melodic) - 1.8.21-1

The packages in the `pr2_mechanism` repository were released into the `melodic` distro by running `/usr/bin/bloom-release pr2_mechanism --rosdistro melodic --track melodic` on `Wed, 22 Jun 2022 08:50:21 -0000`
...
- rosdistro version: `1.8.20-1`
- old version: `1.8.20-1`
...
## pr2_mechanism (noetic) - 1.8.21-1

The packages in the `pr2_mechanism` repository were released into the `noetic` distro by running `/usr/bin/bloom-release pr2_mechanism --rosdistro noetic --track noetic` on `Wed, 22 Jun 2022 08:44:33 -0000`
...
## pr2_mechanism (melodic) - 1.8.20-1

The packages in the `pr2_mechanism` repository were released into the `melodic` distro by running `/usr/bin/bloom-release pr2_mechanism -t melodic -r melodic` on `Mon, 11 Apr 2022 15:04:22 -0000`
...
## pr2_mechanism (noetic) - 1.8.20-1

The packages in the `pr2_mechanism` repository were released into the `noetic` distro by running `/usr/bin/bloom-release pr2_mechanism -t noetic -r noetic` on `Mon, 11 Apr 2022 14:56:36 -0000`
...
## pr2_mechanism (lunar) - 1.8.18-0

The packages in the `pr2_mechanism` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --edit -y pr2_mechanism --rosdistro lunar --track lunar` on `Tue, 11 Sep 2018 07:24:29 -0000`
...
## pr2_mechanism (melodic) - 1.8.18-0

The packages in the `pr2_mechanism` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -y pr2_mechanism --rosdistro melodic --track melodic` on `Tue, 11 Sep 2018 07:18:49 -0000`
